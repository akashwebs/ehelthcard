...
import { Menu,CalendarDays, Landmark, ChevronRight, AlertCircle, Clock, Users, Zap, Heart, Pill, AlertTriangle, MapPin, Phone, Calendar, Droplet } from 'lucide-react'

import Link from 'next/link'
import Sidebar from './Sidebar'
import NoticeMarquee from './NoticeMarquee'

export function HealthCardDashboard() {
  ...
  {new Date().toLocaleString("en-GB", {
   ...
   <NoticeMarquee />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[170px_1fr_360px] gap-6 items-center">
        ...
        {/* Patient Photo */}
        <div className="w-[150px] h-[170px] rounded-xl overflow-hidden border border-slate-100 bg-slate-100 shadow-sm">
          <img
            src="/profile.jpg"
            alt="Patient"
        ...
        {/* Government Box */}
        <div className="rounded-2xl bg-gradient-to-br from-emerald-50 via-white to-emerald-100 p-5 min-h-[170px]">
          ...
          <div className="grid grid-cols-[1fr_1px_1fr] gap-6 mt-7">
            <div>
  ...
  className="inline-flex items-center justify-center px-6 py-3 bg-green-700 text-white font-bold rounded-md hover:bg-green-800 transition-all duration-300"
>
